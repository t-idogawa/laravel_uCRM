                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-500" v-if="errors.kana">{{ errors.kana }}</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-500" v-if="errors.tel">{{ errors.tel }}</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-500" v-if="errors.postcode">{{ errors.postcode }}</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-500" v-if="errors.birthday">{{ errors.birthday }}</div>
                                                </div>
                                            </div>
